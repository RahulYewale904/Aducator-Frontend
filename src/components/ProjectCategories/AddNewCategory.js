...
import {createCategoryAction} from '../../redux/slices/catrgory/categorySlice'
        ...
        {appErr || serverErr ? (
          ...
          <div>
            <div className=" mx-auto text-center">
            {
                  ...
                  <button type="submit" className="uk-button bg-primeBlue rounded-full text-white font-semibold py-1">Add new Category</button>
