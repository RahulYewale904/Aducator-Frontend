...
import {detailCategoriesAction , updateCategoriesAction , deleteCategoriesAction} from '../../redux/slices/catrgory/courseCategory'
...
//get data from store
const state = useSelector(state => state?.CourseCategory);
